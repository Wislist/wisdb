...
# Start server (port 3307, 64MB cache)
...
| [Getting Started](doc/getting-started.md) | Build, run, driver usage, tests |
| [SQL Reference](doc/sql-reference.md) | Full syntax and examples |
